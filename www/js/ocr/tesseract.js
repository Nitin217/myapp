...
var defaultOptions = {
     workerPath: '/android_asset/www/js/ocr/worker.js',
    corePath: 'file:///android_asset/www/js/ocr/index.js',
    langPath: 'file:///android_asset/www/js/ocr/'
};
...
if (process.env.NODE_ENV === "development") {
   ...
   // defaultOptions.workerPath = 'https://cdn.rawgit.com/naptha/tesseract.js/' + version + '/dist/worker.js';
    ...
    {
    	defaultOptions.workerPath= location.protocol + '//' + location.host +'/js/ocr/worker.js';
    	defaultOptions.corePath= location.protocol + '//' + location.host+'/js/ocr/index.js';
    	defaultOptions.langPath= location.protocol + '//' + location.host+'/js/ocr/';
    	
    }
    else{
  
    	defaultOptions.workerPath= 'file:///android_asset/www/js/ocr/worker.js';
